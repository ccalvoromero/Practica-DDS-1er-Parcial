...
public class RentSave implements OperationType {
    ...
    public String buildQuery(Customer customer, Movie movie) {
        ...
        String customerPurchasedMovies =
            "insert customer_rented_movies (customer_id, physical_movie_id, rented_start_date) " +
            "values (" + customerQuery + ", "+ movie.physicalMovieId() + ", sysdate());";
